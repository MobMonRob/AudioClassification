...
def plotCWT(PATH, sr = 8000, start = 0, end = None):
    ...
    gs = GridSpec(2, 2* max + 1, hspace=0.4, wspace=0.75)
    ...
    for i in range(0, max):
        ...
        if (i == 0):
            plt.xlabel('Time (seconds)')
            plt.ylabel('RPM')
            plt.title('b) Wavelet Power Spectrum (contours at 6.25E-2, 1.25E-1, 0.25, 0.5)')
...
plotCWT("audio/16-11-07.wav", start=0, end=50)
